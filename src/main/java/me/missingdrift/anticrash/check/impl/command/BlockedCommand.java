package me.missingdrift.anticrash.check.impl.command;
...
public class BlockedCommand extends BaseCheck {
    ...
    private final List<String> disallowedCommands = AnticrashConfig.getInstance().getDisallowedCommands();
    ...
    private boolean checkPermissions(PacketReceiveEvent event) {
        ...
        return player.hasPermission(AnticrashConfig.getInstance().getPermissionsConfig().getCommandBypassPermission()) || player.isOp();
    }
